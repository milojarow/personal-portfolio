        ...
        <section>
          ...
          <ul className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
            <li>
              <a
                href={`mailto:${t("email")}`}
                className="hover:text-accent transition-colors mono"
              >
                {t("email")}
              </a>
            </li>
            <li>
              <a
                href={`tel:+${t("whatsapp").replace(/\D/g, "")}`}
                aria-label={`Llamar ${t("whatsapp")}`}
                className="inline-flex items-center gap-2 hover:text-accent transition-colors mono"
              >
                <PhoneIcon />
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={`Telegram ${t("telegram")}`}
